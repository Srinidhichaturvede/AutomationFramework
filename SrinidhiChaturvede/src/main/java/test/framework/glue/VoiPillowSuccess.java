...
public class VoiPillowSuccess extends DriverInitialization {
	...
	public void getCreditCardDetails() {
		if (driver.findElement(By.xpath(Voi.getProperty("Promocardcheck"))).isEnabled()) {
	...
	public void orderConfirmation() {
		...
		wait.until(ExpectedConditions
				.visibilityOf(driver.findElement(By.xpath(Voi.getProperty("Transaction_confirmation")))));
